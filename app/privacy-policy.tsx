    ...
    <View className="flex-1 dark:bg-black/80">
      <ScrollView className="p-5">
        ...
        <Text className="text-xl font-normal dark:text-white my-2">
          ...
          libero recusandae exercitationem est cum itaque. Veniam quam doloribus
          nam, officiis sed ipsam suscipit eaque consectetur. Exercitationem
          reprehenderit voluptates quas sequi? Dolorem cumque corporis, facilis
          nisi assumenda labore explicabo ad sit nulla veniam optio illo quaerat
          consectetur reprehenderit error, impedit repellat quos, laudantium
          porro sunt nihil vitae eveniet?
        </Text>
        <Text className="text-xl font-normal dark:text-white my-2">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eaque, hic
          laborum, nemo obcaecati consequatur explicabo ab tempora, saepe
